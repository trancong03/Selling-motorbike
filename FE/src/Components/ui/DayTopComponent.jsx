                ...
                <div className='flex justify-center items-center gap-8'>
                    ...
                    <div className='w-2/3 min-h-[80vh] bg-white rounded-lg shadow-xl border border-gray-200'>
                        ...
                        <div className="p-6 bg-gray-100 rounded-lg max-w-md mx-auto">
                            <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">Đẩy Bài Viết Lên Top</h2>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    <label className="block text-gray-700 font-medium">Vị Trí Top:</label>
                                    <input
                                        type="number"
                                        value={top}
                                    ...
                                    />
                                    {requiredValue && <p className="text-gray-800 mt-2">Bài viết của bạn đang ở top : {curenttop}</p>}
                                    {requiredValue && <p className="text-gray-800 mt-2">Giá trị cần nạp: {requiredValue}</p>}
                                </div>
                                <button type="submit" className="w-full bg-blue-600 text-white font-medium py-2 px-4 rounded-lg hover:bg-blue-700">
                                    Đẩy Lên Top
                                </button>
                            </form>
