      ...
      <div className=" mx-auto w-full bg-white shadow-lg rounded-md flex justify-start items-start gap-4">
          ...
          <div className='h-auto w-[60vw] mt-8'>
              ...
              <div className="grid grid-cols-2 gap-4 mt-3">
                  ...
                  <div className="relative">
                      <input type="date" value={user.birthdate} className="block w-full px-4 py-2 text-gray-500 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
