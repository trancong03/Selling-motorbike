...
def extract_text_from_image(img):
    ...
    raw_text = pytesseract.image_to_string(processed_img, lang="vie+eng")
...
def scan_cccd(request):
    ...
    try:
        ...
        cut_img_address = img[row_address_lineFirst:rows-int(rows*0.12), col_address_lineFirst:cols-int(cols*0)]
